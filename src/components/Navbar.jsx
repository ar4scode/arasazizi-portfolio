...
export default function Navbar() {
  return (
    <ul className="fixed flex bottom-3 left-1/2 transform -translate-x-1/2 bg-white border border-gray-200 rounded-xl py-3 shadow-xl px-5 gap-4 backdrop-blur-md :">
      {[
